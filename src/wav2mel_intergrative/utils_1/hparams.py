...
from utils_1.os_utils import remove_file
...
def set_hparams(config='/path/to/hifigan.yaml', exp_name='', hparams_str='', print_hparams=False, global_hparams=True):
    if config == '' and exp_name == '':
        ...
        parser.add_argument('--tpu', action='store_true', help='tpu')
    ...
    hparams_['tpu'] = getattr(args, 'tpu', False)
